...
//
//     final createTrainerModel = createTrainerModelFromJson(jsonString);

import 'dart:convert';

CreateTrainerModel createTrainerModelFromJson(String str) => CreateTrainerModel.fromJson(json.decode(str));

String createTrainerModelToJson(CreateTrainerModel data) => json.encode(data.toJson());
